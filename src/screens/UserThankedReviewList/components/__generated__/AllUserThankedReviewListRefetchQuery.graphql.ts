/**
 * @generated SignedSource<<496fb1c6c745b0daca246a0233f341d5>>
...
export type AllUserThankedReviewListRefetchQuery$variables = {
  count?: number | null;
  cursor?: string | null;
  id: string;
};
export type AllUserThankedReviewListRefetchQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"AllUserThankedReviewList">;
  } | null;
};
export type AllUserThankedReviewListRefetchQuery = {
  response: AllUserThankedReviewListRefetchQuery$data;
  variables: AllUserThankedReviewListRefetchQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "2b470375421ca38d090a3a8ae622be1c",
    "id": null,
    "metadata": {},
    "name": "AllUserThankedReviewListRefetchQuery",
    "operationKind": "query",
